...
//DO NOT PASS java.lang.String into functions, they can die if they try to mutate java's immutable strings
char** stringy(char** string) {
    string[0][0] ='b';
    return string;
}
...
{
   //calls to native functions like atoi require nativepointers, which strings will not be made into
   //you have to copy them into native memory
